...
*Best for: Learning concepts, day-to-day development, and API refs.*
...
- *Look in `rfcs/rfcs/` for specific deep dives into features like Content History or Internationalization.*

---

## 🎨 3. Design System & UI
*Best for: Building custom plugins and Admin UI extensions.*
...
*Best for: Debugging, understanding internal logic, and advanced hacking.*
