...
Through the _Profile_ page, accessible by clicking on your profile picture on the top right hand corner of the interface then clicking on **Profile**, you can access the [<Icon name="credit-card" /> _Billing_](#account-billing) and [<Icon name="invoice" /> _Invoices_](#account-invoices) tabs.

## Account billing

The <Icon name="credit-card" /> _Billing_ tab displays and enables you to modify the billing details and payment method set for the account.
...
The <Icon name="invoice" /> _Invoices_ tab displays the complete list of invoices for all your Strapi Cloud projects.
