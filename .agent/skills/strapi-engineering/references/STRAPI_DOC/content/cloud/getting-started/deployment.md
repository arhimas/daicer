...
1. From the _Projects_ page, click the **Create project** button.
...
4. Connect a git repository to your new Strapi Cloud project.
   ...
   - by using a prebuilt template and creating a new repository on GitHub to discover Strapi Cloud easily and quickly _(recommended for new users and beginners — not available on another provider than GitHub)_,
   ...
   4.b. In the _Create repository with template_ modal, choose:
   ...
   4.e. Back in the project deployment interface, select your _Account_ and the _Repository_ you just created.
   ...
   4.c. Back in the project deployment interface, select your _Account_ and a _Repository_.
