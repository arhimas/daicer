...
### 1. Safety Baseline
1.  **Pre-Flight Check**: Run all tests *before* touching a single line of code.
    *   *Abort*: If tests fail initially, fix them or simple-fix them first. You cannot refactor on broken ground.
