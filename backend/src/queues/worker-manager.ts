...
const workerRegistry: Record<string, (job: any, strapi: Core.Strapi) => Promise<any>> = {};
...
export class WorkerManager {
   ...
   */
  static register(queueName: QueueName, handler: (job: any, strapi: Core.Strapi) => Promise<any>) {
