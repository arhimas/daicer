  ...
  try {
    ...
    for (const file of files) {
        ...
        if (existing) {
            ...
            // Update
            updates.push(() => strapi.documents('api::knowledge-snippet.knowledge-snippet').update({
            ...
            // Create
            creates.push(() => strapi.documents('api::knowledge-snippet.knowledge-snippet').create({
                data: {
    ...
    console.log(`⚡ Updates: ${updated}, Creates: ${created}, Skipped: ${skipped}`);
