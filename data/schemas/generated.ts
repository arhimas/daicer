...
export const GameSpellbookSchema = z.object({
...
export const GameSpellDataSchema = z.object({
...
export const GameSpellComponentsSchema = z.object({
...
export const GameRangeConfigSchema = z.object({
...
export const GamePositionSchema = z.object({
...
export const GameMechanicsConfigSchema = z.object({
  action_type: z.enum(["Melee Spell Attack", "Ranged Spell Attack", "Strength Save", "Dexterity Save", "Constitution Save", "Intelligence Save", "Wisdom Save", "Charisma Save", "Auto-Hit", "None"]).default("None"),
  save_effect: z.enum(["Negate", "Half", "None"]).optional(),
}).strict();

export const GameInventoryItemSchema = z.object({
  item: z.union([z.string(), z.number()]).optional(),
  quantity: z.number().optional().default(1),
  slot: z.enum(["backpack", "main_hand", "off_hand", "armor", "head", "feet", "neck", "hands", "cloak", "ring_1", "ring_2", "accessory"]).optional().default("backpack"),
...
export const GameEquipmentDataSchema = z.object({
...
export const GameDurationConfigSchema = z.object({
...
export const GameDmStyleSchema = z.object({
...
export const GameDamageModifierSchema = z.object({
...
export const GameDamageInstanceSchema = z.object({
...
export const GameDamageDiceSchema = z.object({
  dice: z.string(),
  bonus: z.number().optional().default(0),
  type: z.string().optional(),
}).strict();

export const GameConditionInstanceSchema = z.object({
...
export const GameComputedActionSchema = z.object({
  name: z.string(),
...
export const GameClassProgressionSchema = z.object({
  level: z.number(),
...
export const GameCharacterClassSchema = z.object({
  class: z.union([z.string(), z.number()]).optional(),
  level: z.number().default(1),
  subclass: z.union([z.string(), z.number()]).optional(),
}).strict();

export const GameCastingConfigSchema = z.object({
...
export const GameAreaEffectSchema = z.object({
...
export const GameActionSchema = z.object({
  ...
  duration: z.enum(["instantaneous", "concentration", "one_minute", "ten_minutes", "one_hour", "eight_hours", "twenty_four_hours", "until_dispelled", "special"]).optional().default("instantaneous"),
  description: z.string().optional(),
  action_definition: z.union([z.string(), z.number()]).optional(),
  spell_definition: z.union([z.string(), z.number()]).optional(),
}).strict();

export const ApiActionActionSchema = z.object({
  name: z.string(),
...
export const ApiCharacterCharacterSchema = z.object({
  name: z.string(),
...
export const ApiClassClassSchema = z.object({
  slug: z.string(),
  name: z.string(),
  embedding: z.any().optional(),
  description: z.string().optional(),
...
export const ApiDamageTypeDamageTypeSchema = z.object({
  slug: z.string(),
  name: z.string(),
  embedding: z.any().optional(),
  description: z.string().optional(),
...
export const ApiDmSettingDmSettingSchema = z.object({
...
export const ApiEntityEntitySchema = z.object({
  slug: z.string(),
  embedding: z.any().optional(),
...
export const ApiEntitySheetEntitySheetSchema = z.object({
  name: z.string().optional(),
...
export const ApiEquipmentCategoryEquipmentCategorySchema = z.object({
  slug: z.string(),
  embedding: z.any().optional(),
  name: z.string(),
  description: z.string().optional(),
...
export const ApiFeatureFeatureSchema = z.object({
  slug: z.string(),
  embedding: z.any().optional(),
  name: z.string(),
  description: z.string().optional(),
...
export const ApiGameEventGameEventSchema = z.object({
  type: z.enum(["ATTACK", "ATTACK_RESULT", "SPELL_CAST", "MOVE", "ENTITY_MOVED", "SKILL_CHECK", "SKILL_CHECK_RESULT", "INTERACT", "OBJECT_INTERACTION", "LONG_REST", "LONG_REST_COMPLETED", "SHORT_REST", "DEATH_SAVE", "ENTITY_DEATH", "INITIATIVE", "TURN_START", "TURN_END", "TERRAIN_MODIFIED", "SPAWN_ENTITY", "ENTROPY_CHANGE", "ITEM_DROP", "ITEM_PICKUP"]),
...
export const ApiItemItemSchema = z.object({
  name: z.string(),
  slug: z.string(),
  description: z.string().optional(),
  type: z.enum(["weapon", "armor", "consumable", "tool", "loot", "spell_scroll", "feature", "container"]).default("loot"),
...
export const ApiKnowledgeSnippetKnowledgeSnippetSchema = z.object({
  title: z.string(),
  content: z.string(),
...
export const ApiKnowledgeSourceKnowledgeSourceSchema = z.object({
  name: z.string(),
  content: z.string(),
  tags: z.any().optional(),
...
export const ApiLanguageLanguageSchema = z.object({
  slug: z.string(),
  embedding: z.any().optional(),
  name: z.string(),
...
export const ApiMagicSchoolMagicSchoolSchema = z.object({
  slug: z.string(),
  embedding: z.any().optional(),
  name: z.string(),
  description: z.string().optional(),
...
export const ApiMessageMessageSchema = z.object({
  content: z.string(),
...
export const ApiProficiencyProficiencySchema = z.object({
  slug: z.string(),
  name: z.string(),
  embedding: z.any().optional(),
  type: z.enum(["Armor", "Weapons", "Tools", "Artisan's Tools", "Gaming Sets", "Musical Instruments", "Vehicles", "Other", "Saving Throws", "Skills"]).optional(),
...
export const ApiPromptPromptSchema = z.object({
  key: z.string(),
...
export const ApiRaceRaceSchema = z.object({
  slug: z.string(),
  embedding: z.any().optional(),
  name: z.string(),
  description: z.string().optional(),
...
export const ApiRoomRoomSchema = z.object({
  roomId: z.string().optional(),
  owner: z.union([z.string(), z.number()]).optional(),
  phase: z.enum(["lobby", "character_creation", "world_generation", "gameplay", "combat", "ending"]).optional().default("lobby"),
...
export const ApiRuleSetRuleSetSchema = z.object({
  xp_table: z.any(),
...
export const ApiSpellSpellSchema = z.object({
  slug: z.string(),
  name: z.string(),
  level: z.number().optional(),
  school: z.enum(["Abjuration", "Conjuration", "Divination", "Enchantment", "Evocation", "Illusion", "Necromancy", "Transmutation"]).optional(),
...
export const ApiSubclassSubclassSchema = z.object({
  slug: z.string(),
  embedding: z.any().optional(),
  name: z.string(),
  description: z.string().optional(),
...
export const ApiTimeFrameTimeFrameSchema = z.object({
  turnNumber: z.number(),
  timestamp: z.any(),
  room: z.union([z.string(), z.number()]).optional(),
  gameState: z.any(),
...
export const ApiTraitTraitSchema = z.object({
  slug: z.string(),
  embedding: z.any().optional(),
  name: z.string(),
  description: z.string().optional(),
...
export const ApiTurnTurnSchema = z.object({
...
export const ApiTurnLockTurnLockSchema = z.object({
  room: z.union([z.string(), z.number()]).optional(),
  locked_at: z.any(),
  expires_at: z.any(),
  holder_id: z.string(),
...
export const ApiVoxelChangeVoxelChangeSchema = z.object({
  chunkX: z.number(),
  chunkY: z.number(),
  voxelX: z.number(),
  voxelY: z.number(),
...
export const ApiWeaponPropertyWeaponPropertySchema = z.object({
  slug: z.string(),
  embedding: z.any().optional(),
  name: z.string(),
  description: z.string().optional(),
...
export const ApiWorldWorldSchema = z.object({
  room: z.union([z.string(), z.number()]).optional(),
