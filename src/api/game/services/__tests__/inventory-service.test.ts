...
describe('Inventory Service', () => {
  ...
  describe('equipItem', () => {
    ...
    it('unequips Off Hand when equipping Two-Handed weapon', async () => {
      const initialInventory = [makeItem(1, 'Shield', 'off_hand'), makeItem(2, 'Greatsword', null, ['two-handed'])];
    ...
    it('unequips Two-Handed weapon when equipping Off Hand', async () => {
      const initialInventory = [makeItem(1, 'Greatsword', 'main_hand', ['two-handed']), makeItem(2, 'Shield', null)];
  ...
  describe('calculateWeight', () => {
    it('sums weights correctly', async () => {
      const inv = [makeItem(1, 'Rock', null, [], 5), { ...makeItem(2, 'Feather', null, [], 0.1), quantity: 10 }];
