...
describe('Lock Service', () => {
  ...
  describe('acquire', () => {
    ...
    it('should reject if valid lock exists', async () => {
      ...
      mockDocuments.findMany.mockResolvedValue([{ documentId: 'lock-1', expires_at: future, holder_id: 'holder-2' }]);
    ...
    it('should cleanup and acquire if lock expired', async () => {
      ...
      mockDocuments.findMany.mockResolvedValue([{ documentId: 'lock-1', expires_at: past, holder_id: 'holder-2' }]);
  ...
  describe('forceRelease', () => {
    it('should delete all locks for room', async () => {
      mockDocuments.findMany.mockResolvedValue([{ documentId: 'lock-1' }, { documentId: 'lock-2' }]);
