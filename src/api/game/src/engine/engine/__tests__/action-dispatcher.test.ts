...
import { GameState, MoveCommand, AttackCommand } from '../../types';
...
describe('Engine ActionDispatcher', () => {
    ...
    beforeEach(() => {
        ...
        mockState = {
            entities: [
                { id: 'actor1', position: { x: 0, y: 0, z: 0 }, hp: 10, maxHp: 10, speed: 30, actions: [{id: 'strike', name: 'Strike'}] },
    ...
    describe('handleMove', () => {
        it('should return failure if actor not found', () => {
           const cmd: MoveCommand = { type: 'MOVE', id: '1', timestamp: 0, payload: { actorId: 'missing', targetPosition: {x:1, y:1, z:0} } };
        ...
        it('should move if path found', () => {
            vi.mocked(findPath).mockReturnValue([ {x:0, y:0, z:0}, {x:5, y:0, z:0} ]);
            const cmd: MoveCommand = { type: 'MOVE', id: '1', timestamp: 0, payload: { actorId: 'actor1', targetPosition: {x:5, y:0, z:0} } };
    ...
    describe('handleAttack', () => {
        it('should resolve attack and apply damage', () => {
            ...
            const cmd: AttackCommand = { type: 'ATTACK', id: '2', timestamp: 0, payload: { actorId: 'actor1', targetId: 'target1' } };
            const result = dispatcher.dispatch(mockState, cmd);
