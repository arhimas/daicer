...
import { SneakAttack } from '@daicer/engine/mechanics/features/sneak-attack';
import { Entity, EntityAction } from '@/api/game/src/types'; // Adjust path
import { CombatContext } from '@daicer/engine/mechanics/registry/FeatureRegistry';
