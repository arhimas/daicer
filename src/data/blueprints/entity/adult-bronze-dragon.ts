...
export default defineEntity({
  ...
  actions: [
    'adult-bronze-dragon-amphibious',
    'adult-bronze-dragon-bite',
    'adult-bronze-dragon-claw',
    'adult-bronze-dragon-detect',
    'adult-bronze-dragon-frightful-presence',
    'adult-bronze-dragon-legendary-resistance-3-day',
    'adult-bronze-dragon-lightning-breath',
    'adult-bronze-dragon-multiattack',
    'adult-bronze-dragon-repulsion-breath',
    'adult-bronze-dragon-tail-attack',
    'adult-bronze-dragon-tail',
  ],
  legendary_actions: ['adult-bronze-dragon-wing-attack-costs-2-actions'],
});
