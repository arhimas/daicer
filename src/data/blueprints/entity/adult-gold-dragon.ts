...
export default defineEntity({
  ...
  actions: [
    'adult-gold-dragon-amphibious',
    'adult-gold-dragon-bite',
    'adult-gold-dragon-claw',
    'adult-gold-dragon-detect',
    'adult-gold-dragon-fire-breath',
    'adult-gold-dragon-frightful-presence',
    'adult-gold-dragon-legendary-resistance',
    'adult-gold-dragon-multiattack',
    'adult-gold-dragon-tail-attack',
    'adult-gold-dragon-tail',
    'adult-gold-dragon-weakening-breath',
    'adult-gold-dragon-wing-attack',
  ],
});
