...
export default defineEntity({
  ...
  actions: ['brass-dragon-wyrmling-bite', 'brass-dragon-wyrmling-fire-breath', 'brass-dragon-wyrmling-sleep-breath'],
});
