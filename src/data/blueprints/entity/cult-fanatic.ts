...
export default defineEntity({
  ...
  actions: ['cult-fanatic-dark-devotion', 'cult-fanatic-multiattack', 'cult-fanatic-spellcasting'],
  spells: [
    'command',
    'hold-person',
    'inflict-wounds',
