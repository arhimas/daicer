...
export default defineEntity({
  ...
  actions: [
    'dryad-fey-charm',
    'dryad-innate-spellcasting',
    'dryad-magic-resistance',
    'dryad-speak-with-beasts-and-plants',
    'dryad-tree-stride',
  ],
  spells: ['barkskin', 'druidcraft', 'entangle', 'goodberry', 'pass-without-trace', 'shillelagh'],
});
