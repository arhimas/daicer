...
export default defineFeature({
  ...
  compilation_state: {
    ...
    summary: 'Successfully parsed Circle Spells feature for the Land Druid.',
  },
  description:
  ...
  image: '',
  level: 5,
  lore: "A druid's bond with their chosen environment grants them specialized knowledge and magical prowess unique to that terrain.",
