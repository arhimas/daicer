...
export default defineFeature({
  ...
  compilation_state: {
    status: 'Valid',
    summary: 'Successfully mapped from 5e reference data.',
  },
  description:
  ...
  image: '',
  level: 1,
  lore: 'Monks of various traditions practice specialized forms of combat, turning their bodies and simple tools into deadly weapons.',
