...
export default defineFeature({
  ...
  compilation_state: {
    status: 'Valid',
    summary: 'Sorcerer class feature providing spell customization options.',
  },
  description:
  ...
  level: 10,
  lore: "The sorcerer's magic is a fluid thing, responding to their intent and emotion to change its form and effect.",
  tags: ['sorcerer'],
});
