...
export default defineSpell({
  ...
  casting_config: {
    ...
    components: {
      ...
      cost_gp: 0,
      material: true,
      material_description: 'An eggshell and a snakeskin glove.',
      somatic: true,
      verbal: true,
    },
  },
  ...
  condition_instances: [
    {
      condition: 'Grappled',
      description: 'Grasping Hand attempts to grapple a Huge or smaller creature within 5 feet of it.',
      chance: 100,
    },
  ],
  scaling_config: {
  ...
  compilation_state: {
    status: 'Valid',
    summary: 'Successfully mapped Arcane Hand spell data.',
  },
});
