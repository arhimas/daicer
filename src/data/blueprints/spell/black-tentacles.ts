...
export default defineSpell({
  ...
  casting_config: {
    ...
    components: {
      ...
      cost_gp: 0,
      material: true,
      material_description: 'A piece of tentacle from a giant octopus or a giant squid',
      somatic: true,
      verbal: true,
    },
  },
  ...
  condition_instances: [
    {
      ...
      description: 'A creature that fails its saving throw is restrained by the tentacles until the spell ends.',
      chance: 100,
    },
  ],
  scaling_config: {
