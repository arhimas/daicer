...
export default defineSpell({
  ...
  condition_instances: [
    {
      condition: 'Prone',
      description: 'If the command Grovel is issued, the target falls prone.',
      chance: 100,
    },
    {
      condition: 'Special',
      description: 'The target follows a one-word command such as Approach, Drop, Flee, or Halt.',
      chance: 100,
    },
  ],
  scaling_config: {
