...
export default defineSpell({
  ...
  casting_config: {
    ...
    components: {
      ...
      cost_gp: 0,
      material: true,
      material_description: 'A handful of sand, a dab of ink, and a writing quill plucked from a sleeping bird.',
      somatic: true,
      verbal: true,
    },
  },
  ...
  condition_instances: [
    {
      condition: 'Special',
      description: 'On a failed save, a nightmare prevents the target from gaining any benefit from that rest.',
      chance: 100,
    },
  ],
  description:
