  ...
  condition_instances: [
    {
      condition: 'Special',
      description:
        'Creatures swimming on the surface of frozen water are trapped in the ice and must use an action to make a Strength check against your spell save DC to break free.',
      chance: 100,
      duration_rounds: 10,
    },
  ],
