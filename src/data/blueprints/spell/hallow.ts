...
export default defineSpell({
  ...
  casting_config: {
    ...
    components: {
      ...
      cost_gp: 1000,
      material: true,
      material_description: 'Herbs, oils, and incense worth at least 1,000 gp, which the spell consumes.',
      somatic: true,
      verbal: true,
    },
  },
  ...
  condition_instances: [
    {
      ...
      description: 'Affected creatures are frightened while in the area if the Fear effect is chosen.',
      chance: 100,
    },
    {
      condition: 'Special',
      description: 'Prevents charm and possession by specific creature types.',
      chance: 100,
    },
  ],
  description:
