...
export default defineSpell({
  ...
  casting_config: {
    ...
    components: {
      ...
      cost_gp: 500,
      material: true,
      material_description: 'A gem, crystal, reliquary, or some other ornamental container worth at least 500 gp.',
      somatic: true,
      verbal: true,
    },
  },
  ...
  condition_instances: [
    {
      condition: 'Special',
      description: 'Catatonic state for the original body; possession for the target humanoid.',
      chance: 100,
    },
  ],
  description:
