  ...
  condition_instances: [
    {
      condition: 'Paralyzed',
      description:
        'The vampire is paralyzed until it regains at least 1 hit point after reverting to its vampire form in its resting place.',
      chance: 100,
      duration_rounds: null,
    },
  ],
  slug: 'vampire-vampire-misty-escape',
});
