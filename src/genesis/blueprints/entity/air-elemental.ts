...
export default defineEntity({
  ...
  actions: ['air-elemental-air-form', 'air-elemental-multiattack', 'air-elemental-slam', 'air-elemental-whirlwind'],
});
