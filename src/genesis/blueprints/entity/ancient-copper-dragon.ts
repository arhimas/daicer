...
export default defineEntity({
  ...
  actions: [
    ...
    'ancient-copper-dragon-bite',
    'ancient-copper-dragon-change-shape',
    'ancient-copper-dragon-claw',
    'ancient-copper-dragon-detect',
    'ancient-copper-dragon-frightful-presence',
    'ancient-copper-dragon-legendary-resistance',
    'ancient-copper-dragon-multiattack',
    'ancient-copper-dragon-slowing-breath',
    'ancient-copper-dragon-tail-attack',
    'ancient-copper-dragon-tail',
    'ancient-copper-dragon-wing-attack',
  ],
});
