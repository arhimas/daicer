...
export default defineEntity({
  ...
  actions: [
    'ancient-gold-dragon-amphibious',
    'ancient-gold-dragon-bite',
    'ancient-gold-dragon-change-shape',
    'ancient-gold-dragon-claw',
    'ancient-gold-dragon-detect',
    'ancient-gold-dragon-fire-breath',
    'ancient-gold-dragon-frightful-presence',
    'ancient-gold-dragon-legendary-resistance-3-day',
    'ancient-gold-dragon-multiattack',
    'ancient-gold-dragon-tail-attack',
    'ancient-gold-dragon-tail',
    'ancient-gold-dragon-weakening-breath',
    'ancient-gold-dragon-wing-attack',
  ],
});
