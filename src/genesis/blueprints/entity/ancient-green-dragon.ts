...
export default defineEntity({
  ...
  actions: [
    'ancient-green-dragon-amphibious',
    'ancient-green-dragon-bite',
    'ancient-green-dragon-claw',
    'ancient-green-dragon-detect',
    'ancient-green-dragon-frightful-presence',
    'ancient-green-dragon-legendary-resistance-3-day',
    'ancient-green-dragon-multiattack',
    'ancient-green-dragon-poison-breath',
    'ancient-green-dragon-tail-attack',
    'ancient-green-dragon-tail',
    'ancient-green-dragon-wing-attack',
  ],
});
