...
export default defineFeature({
  ...
  compilation_state: {
    status: 'Valid',
    hash: '7e3b8a1c9f2d4e6a8b0c2d4e6f8a0b1c',
  ...
  embedding: {},
  level: 15,
  lore: 'The ultimate test of a hunter is the ability to survive the most lethal counterattacks.',
  tags: ['ranger', 'hunter', 'subclass-feature'],
});
