  ...
  condition_instances: [
    {
      ...
      description: 'The target is restrained until the spell ends (Chaining form).',
      chance: 100,
    },
    {
      condition: 'Unconscious',
      description: "The target falls asleep and can't be awoken (Slumber form).",
      chance: 100,
    },
    {
      condition: 'Special',
      description:
        'The target is entombed, transported to a demiplane, or shrunk (Burial, Hedged Prison, or Minimus Containment).',
      chance: 100,
    },
  ],
  description:
