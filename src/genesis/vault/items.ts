import { SeedItem } from '@/genesis/schemas/molecules';
...
export const ITEMS: SeedItem[] = [
  ...
  },
  {
    ...
    weight: 0,
    description:
      "While holding this fan, you can use an action to cast the [_gust of wind_](#gust-of-wind) spell (save DC 13) from it. Once used, the fan shouldn't be used again until the next dawn. Each time it is used again before then, it has a cumulative 20 percent chance of not working and tearing into useless, nonmagical tatters.",
    tags: [],
  },
  {
  ...
  },
  {
    ...
    weight: 0,
    description:
      "This wand has 7 charges. While holding it, you can use an action to expend 1 of its charges to cast the [_web_](#web) spell (save DC 15) from it.\n\nThe wand regains 1d6 + 1 expended charges daily at dawn. If you expend the wand's last charge, roll a d20. On a 1, the wand crumbles into ashes and is destroyed.",
    tags: [],
  },
  {
  ...
  },
  {
    ...
    weight: 0,
    description:
      "This wand has 7 charges. While holding it, you can use an action to expend 1 of its charges to cast the [_polymorph_](#polymorph) spell (save DC 15) from it.\n\nThe wand regains 1d6 + 1 expended charges daily at dawn. If you expend the wand's last charge, roll a d20. On a 1, the wand crumbles into ashes and is destroyed.",
    tags: [],
  },
  {
  ...
  },
  {
    ...
    weight: 0,
    description:
      "This wand has 7 charges. While holding it, you can use an action to expend 1 or more of its charges to cast the [_magic missile_](#magic-missile) spell from it. For 1 charge, you cast the 1st-level version of the spell. You can increase the spell slot level by one for each additional charge you expend.\n\nThe wand regains 1d6 + 1 expended charges daily at dawn. If you expend the wand's last charge, roll a d20. On a 1, the wand crumbles into ashes and is destroyed.",
    tags: [],
  },
  {
    ...
    weight: 0,
    description:
      'This wand has 3 charges. While holding it, you can expend 1 charge as an action to cast the [_detect magic_](#detect-magic) spell from it. The wand regains 1d3 expended charges daily at dawn.',
    tags: [],
  },
  {
    ...
    weight: 0,
    description:
      "This wand has 7 charges. While holding it, you can use an action to expend 1 or more of its charges to cast the [_lightning bolt_](#lightning-bolt) spell (save DC 15) from it. For 1 charge, you cast the 3rd-level version of the spell. You can increase the spell slot level by one for each additional charge you expend.\n\nThe wand regains 1d6 + 1 expended charges daily at dawn. If you expend the wand's last charge, roll a d20. On a 1, the wand crumbles into ashes and is destroyed.",
    tags: [],
  },
  {
    ...
    weight: 0,
    description:
      "This wand has 7 charges. While holding it, you can use an action to expend 1 or more of its charges to cast the [_fireball_](#fireball) spell (save DC 15) from it. For 1 charge, you cast the 3rd-level version of the spell. You can increase the spell slot level by one for each additional charge you expend.\n\nThe wand regains 1d6 + 1 expended charges daily at dawn. If you expend the wand's last charge, roll a d20. On a 1, the wand crumbles into ashes and is destroyed.",
    tags: [],
  },
  {
    name: 'Wand of Fear',
  ...
  },
  {
    ...
    weight: 0,
    description:
      'This trident is a magic weapon. It has 3 charges. While you carry it, you can use an action and expend 1 charge to cast [_dominate beast_](#dominate-beast) (save DC 15) from it on a beast that has an innate swimming speed. The trident regains 1d3 expended charges daily at dawn.',
    tags: [],
  },
  {
  ...
  },
  {
    ...
    weight: 0,
    description:
      'When you make an Intelligence (Arcana) check to control a [_sphere of annihilation_](#item-sphere-of-annihilation) while you are holding this talisman, you double your proficiency bonus on the check. In addition, when you start your turn with control over a _sphere of annihilation_, you can use an action to levitate it 10 feet plus a number of additional feet equal to 10 × your Intelligence modifier.',
    tags: [],
  },
  {
  ...
  },
  {
    ...
    weight: 0,
    description:
      "If the stone is touching the ground, you can use an action to speak its command word and summon an earth elemental, as if you had cast the [_conjure elemental_](#conjure-elemental) spell. The stone can't be used this way again until the next dawn. The stone weighs 5 pounds.",
    tags: [],
  },
  {
  ...
  },
  {
    ...
    weight: 0,
    description:
      "While holding this staff, you can use an action to expend 1 of its 10 charges to cast [_charm person_](#charm-person), [_command_](#command), or [_comprehend languages_](#comprehend-languages) from it using your spell save DC. The staff can also be used as a magic quarterstaff.\n\nIf you are holding the staff and fail a saving throw against an enchantment spell that targets only you, you can turn your failed save into a successful one. You can't use this property of the staff again until the next dawn. If you succeed on a save against an enchantment spell that targets only you, with or without the staff's intervention, you can use your reaction to expend 1 charge from the staff and turn the spell back on its caster as if you had cast the spell.\n\nThe staff regains 1d8 + 2 expended charges daily at dawn. If you expend the last charge, roll a d20. On a 1, the staff becomes a nonmagical quarterstaff.",
    tags: [],
  },
  {
  ...
  },
  {
    ...
    weight: 0,
    description:
      'While wearing this ring, you can use an action to expend 1 of its 3 charges to cast the [_wish_](#wish) spell from it. The ring becomes nonmagical when you use the last charge.',
    tags: [],
  },
  {
  ...
  },
  {
    ...
    weight: 0,
    description:
      "While wearing this ring, you can cast the [_telekinesis_](#telekinesis) spell at will, but you can target only objects that aren't being worn or carried.",
    tags: [],
  },
  {
  ...
  },
  {
    ...
    weight: 0,
    description:
      "When you drink this potion, you gain the effect of the [_haste_](#haste) spell for 1 minute (no concentration required).\n\nThe potion's yellow fluid is streaked with black and swirls on its own.",
    tags: [],
  },
  {
  ...
  },
  {
    ...
    weight: 0,
    description:
      'This concoction looks, smells, and tastes like a potion of healing or other beneficial potion. However, it is actually poison masked by illusion magic. An [_identify_](#identify) spell reveals its true nature.\n\nIf you drink it, you take 3d6 poison damage, and you must succeed on a DC 13 Constitution saving throw or be [poisoned](#poisoned). At the start of each of your turns while you are poisoned in this way, you take 3d6 poison damage. At the end of each of your turns, you can repeat the saving throw. On a successful save, the poison damage you take on your subsequent turns decreases by 1d6. The poison ends when the damage decreases to 0.',
    tags: [],
  },
  {
    ...
    weight: 0,
    description:
      "When you drink this potion, you gain the effect of the [_detect thoughts_](#detect-thoughts) spell (save DC 13). The potion's dense, purple liquid has an ovoid cloud of pink floating in it.",
    tags: [],
  },
  {
  ...
  },
  {
    ...
    weight: 0,
    description:
      'For 1 hour after drinking it, you gain 10 temporary hit points that last for 1 hour. For the same duration, you are under the effect of the [_bless_](#bless) spell (no concentration required). This blue potion bubbles and steams as if boiling.',
    tags: [],
  },
  {
  ...
  },
  {
    ...
    weight: 0,
    description:
      'When you drink this potion, you gain the "enlarge" effect of the [_enlarge/reduce_](#enlargereduce) spell for 1d4 hours (no concentration required). The red in the potion\'s liquid continuously expands from a tiny bead to color the clear liquid around it and then contracts.\n\nShaking the bottle fails to interrupt this process.',
    tags: [],
  },
  {
  ...
  },
  {
    ...
    weight: 0,
    description:
      "When you drink this potion, you gain the effect of the [_gaseous form_](#gaseous-form) spell for 1 hour (no concentration required) or until you end the effect as a bonus action. This potion's container seems to hold fog that moves and pours like water.",
    tags: [],
  },
  {
  ...
  },
  {
    ...
    weight: 0,
    description:
      'When you drink this potion, you gain the "reduce" effect of the [_enlarge/reduce_](#enlargereduce) spell for 1d4 hours (no concentration required). The red in the potion\'s liquid continuously contracts to a tiny bead and then expands to color the clear liquid around it. Shaking the bottle fails to interrupt this process.',
    tags: [],
  },
  {
  ...
  },
  {
    ...
    weight: 0,
    description:
      'When you drink this potion, you gain the effect of the [_clairvoyance_](#clairvoyance) spell. An eyeball bobs in this yellowish liquid but vanishes when the potion is opened.',
    tags: [],
  },
  {
  ...
  },
  {
    ...
    weight: 0,
    description:
      'This necklace has 1d6 + 3 beads hanging from it. You can use an action to detach a bead and throw it up to 60 feet away. When it reaches the end of its trajectory, the bead detonates as a 3rd-level [_fireball_](#fireball) spell (save DC 15).\n\nYou can hurl multiple beads, or even the whole necklace, as one action. When you do so, increase the level of the [_fireball_](#fireball) by 1 for each bead beyond the first.',
    tags: [],
  },
  {
    ...
    weight: 0,
    description:
      'While wearing this necklace, you can breathe normally in any environment, and you have advantage on saving throws made against harmful gases and vapors (such as [_cloudkill_](#cloudkill) and [_stinking cloud_](#stinking-cloud) effects, inhaled poisons, and the breath weapons of some dragons).',
    tags: [],
  },
  {
    name: 'Mithral Armor',
  ...
  },
  {
    ...
    weight: 0,
    description:
      'The medallion has 3 charges. While wearing it, you can use an action and expend 1 charge to cast the [_detect thoughts_](#detect-thoughts) spell (save DC 13) from it. The medallion regains 1d3 expended charges daily at dawn.',
    tags: [],
  },
  {
  ...
  },
  {
    ...
    weight: 0,
    description:
      'This helm has 3 charges. While wearing it, you can use an action and expend 1 charge to cast the [_teleport_](#teleport) spell from it. The helm regains 1d3 expended charges daily at dawn.',
    tags: [],
  },
  {
  ...
  },
  {
    ...
    weight: 0,
    description:
      'While wearing this helm, you can use an action to cast the [_comprehend languages_](#comprehend-languages) spell from it at will.',
    tags: [],
  },
  {
  ...
  },
  {
    ...
    weight: 0,
    description:
      'While wearing this hat, you can use an action to cast the [_disguise self_](#disguise-self) spell from it at will. The spell ends if the hat is removed.',
    tags: [],
  },
  {
  ...
  },
  {
    ...
    weight: 0,
    description:
      "While wearing this circlet, you can use an action to cast the [_scorching ray_](#scorching-ray) spell with it. When you make the spell's attacks, you do so with an attack bonus of +5. The circlet can't be used this way again until the next dawn.",
    tags: [],
  },
  {
  ...
  },
  {
    ...
    weight: 0,
    description:
      "This cape smells faintly of brimstone. While wearing it, you can use it to cast the [_dimension door_](#dimension-door) spell as an action. This property of the cape can't be used again until the next dawn.\n\nWhen you disappear, you leave behind a cloud of smoke, and you appear in a similar cloud of smoke at your destination. The smoke lightly obscures the space you left and the space you appear in, and it dissipates at the end of your next turn. A light or stronger wind disperses the smoke.",
    tags: [],
  },
  {
  ...
  },
  {
    ...
    weight: 0,
    description:
      'While wearing this brooch, you have resistance to force damage, and you have immunity to damage from the [_magic missile_](#magic-missile) spell.',
    tags: [],
  },
  {
    ...
    weight: 0,
    description:
      "While a fire burns in this brass brazier, you can use an action to speak the brazier's command word and summon a fire elemental, as if you had cast the [_conjure elemental_](#conjure-elemental) spell. The brazier can't be used this way again until the next dawn. The brazier weighs 5 pounds.",
    tags: [],
  },
  {
  ...
  },
  {
    ...
    weight: 0,
    description:
      "While this bowl is filled with water, you can use an action to speak the bowl's command word and summon a water elemental, as if you had cast the [_conjure elemental_](#conjure-elemental) spell. The bowl can't be used this way again until the next dawn.\n\nThe bowl is about 1 foot in diameter and half as deep. It weighs 3 pounds and holds about 3 gallons.",
    tags: [],
  },
  {
  ...
  },
  {
    ...
    weight: 0,
    description:
      'While you wear these boots, you can use an action to cast the [_levitate_](#levitate) spell on yourself at will.',
    tags: [],
  },
  {
