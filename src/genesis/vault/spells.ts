...
export const SPELLS: SeedSpell[] = [
  ...
  },
  {
    ...
    school: 'Abjuration',
    description:
      'An [invisible](#invisible) barrier of magical force appears and protects you. Until the start of your next turn, you have a +5 bonus to AC, including against the triggering attack, and you take no damage from [_magic missile_](#magic-missile).',
    casting_config: {
      time_value: 1,
      time_unit: 'Action',
      is_ritual: false,
  ...
  },
  {
    ...
    school: 'Abjuration',
    description:
      "Until the spell ends, one willing creature you touch is immune to psychic damage, any effect that would sense its emotions or read its thoughts, divination spells, and the [charmed](#charmed) condition. The spell even foils [_wish_](#wish) spells and spells or effects of similar power used to affect the target's mind or to gain information about the target.",
    casting_config: {
      time_value: 1,
      time_unit: 'Action',
      is_ritual: false,
  ...
  },
  {
    ...
    school: 'Abjuration',
    description:
      "You create a ward against magical travel that protects up to 40,000 square feet of floor space to a height of 30 feet above the floor. For the duration, creatures can't teleport into the area or use portals, such as those created by the [_gate_](#gate) spell, to enter the area. The spell proofs the area against planar travel, and therefore prevents creatures from accessing the area by way of the astral, ethereal, fey, or shadow planes, or the [_plane shift_](#plane-shift) spell.\n\nIn addition, the spell damages types of creatures that you choose when you cast it. Choose one or more of the following: celestials, elementals, fey, fiends, and undead. When a chosen creature enters the spell's area for the first time on a turn or starts its turn there, the creature takes 5d10 radiant or necrotic damage (your choice when you cast this spell).\n\nWhen you cast this spell, you can designate a password. A creature that speaks the password as it enters the area takes no damage from the spell.\n\nThe spell's area can't overlap with the area of another _forbiddance_ spell. If you cast _forbiddance_ every day for 30 days in the same location, the spell lasts until it is dispelled, and the material components are consumed on the last casting.",
    casting_config: {
      time_value: 10,
      time_unit: 'Minute',
      is_ritual: true,
  ...
  },
  {
    ...
    school: 'Evocation',
    description:
      "A flame, equivalent in brightness to a torch, springs forth from an object that you touch. The effect looks like a regular flame, but it creates no heat and doesn't use oxygen. A [_continual flame_](#continual-flame) can be covered or hidden but not smothered or quenched.",
    casting_config: {
      time_value: 1,
      time_unit: 'Action',
      is_ritual: false,
