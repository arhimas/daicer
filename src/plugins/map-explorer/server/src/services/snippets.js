...
exports.SNIPPETS = {
    VISION_INSTRUCTION_PREFIX: "Analyze the visual blueprint provided. The colored zones indicate semantic meaning (see system instructions).",
    ...
    IGNORED_SHALLOW_KEYS: [
        'password', 'confirmation', 'createdBy', 'updatedBy',
        'createdAt', 'updatedAt', 'publishedAt', 'localizations', 'locale'
    ],
