...
exports.getZoneCentroid = exports.getVisualBounds = void 0;
// Find the visual bounding box of the non-transparent pixels
const getVisualBounds = (pixels) => {
    var _a;
    const height = pixels.length;
    const width = ((_a = pixels[0]) === null || _a === void 0 ? void 0 : _a.length) || 0;
...
exports.getVisualBounds = getVisualBounds;
// Find the centroid of a specific zone
const getZoneCentroid = (blueprint, targetZone) => {
    let sumX = 0, sumY = 0, count = 0;
    // We also track bounds to find specific edges (like top of head)
    const height = (blueprint === null || blueprint === void 0 ? void 0 : blueprint.length) || 32;
...
exports.getZoneCentroid = getZoneCentroid;
